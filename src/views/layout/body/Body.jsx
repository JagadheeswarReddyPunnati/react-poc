  ...
  render() {
    ...
    return (
      <main className=" container-fluid hide-on-print" id="main-body">
        <div className="row">
          <PanelComponent heading="Welcome to IFMIS" body="Dear User" className="panel-success col-md-3">
            <p>Today is {new Date().toLocaleDateString()}</p>
          </PanelComponent>
          <PanelComponent heading="MaryLand StateStat" description={panelDescription} className="panel-success col-md-6">
            <Switch>
